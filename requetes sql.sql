...
SELECT nom AS "Nom artcile", couleur AS "Couleur", prix_article_ht AS "Prix (€)", seuil AS "Seuil", t.taxe AS "Taxe (%)", quantite_stock AS "Stock" 
FROM article
INNER JOIN taxe AS t ON article.id_taxe = t.id_taxe
